 ...
 * Copyright (C) 2014-1025 Daniel Santos <daniel.santos@pobox.com>
                ...
                size_t n, void *arg)
{
  ...
  assert_const(!d.less + !d.compar + !d.less_r + !d.compar_r);
  assert_const(d.align + d.size);
  BUILD_BUG_ON_MSG(!d.less && !d.compar && !d.less_r && !d.compar_r,
